    ...
    <header class="header">
        <div class="header-1">
            ...
            <div class="icons">
                ...
                if ($is_authenticated) {
                    echo '<p style="color:#000;font-size:100%;"> Welcome <b>'.$user.'</b> '.
                    '&nbsp;&nbsp; | <a href="admin.php" style="font-size:100%;"><i class="fas fa-cog"></i> Panel</a>'.
                    '&nbsp;&nbsp; | <a href="logout.php" style="font-size:100%;">Logout</a></p>';
                } else {
